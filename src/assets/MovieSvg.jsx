...
import SVG2 from './film-svgrepo-com.svg'
export default function MovieSvg({ show = true ,size ,...props}) {
  ...
  >
    <path
      ...
      d="M59.488,117.299c-0.504-4.237-2.007-8.171-4.273-11.556l202.992-67.776L247.552,6.051
  ...
  return (
    <div >
      {/* Render SVG with props */}
      {show && <SVG size={size} {...props}/>}
    </div>
  );
}
